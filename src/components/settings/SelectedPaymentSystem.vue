...
const LOGOS = {
	'Т-банк': '/assets/img/logo-payment-system-01.png',
	Сбербанк: '/assets/img/logo-payment-system-02.png',
	Robokassa: '/assets/img/logo-payment-system-03.png',
	'Ю-kassa': '/assets/img/logo-payment-system-04.png',
}
</script>
...
<template>
	<BaseCard type="small" class="selected-provider">
		<div class="selected-provider__header">
			<img :src="LOGOS[info.bank]" alt="" class="selected-provider__logo" />
